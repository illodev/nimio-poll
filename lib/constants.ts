...
export const MESSAGES = {
  errors: {
    invalidCommand: '❌ Comando inválido. Usa `/poll "Tu pregunta" "Opción 1" "Opción 2"`',
    noQuestion: '❌ Debes incluir una pregunta para la encuesta.',
    notEnoughOptions: '❌ Necesitas al menos 2 opciones para crear una encuesta.',
    ...
    installationError: '❌ Error en la instalación. Por favor, intenta de nuevo.',
